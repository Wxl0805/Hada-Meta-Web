        ...
        <div class="gva-search-box">
          <el-form ref="originInfoForm" :inline="true" :model="originInfo">
            ...
            <el-form-item label="累计收益">
              <el-input v-model.trim="originInfo.totalIncome" placeholder="累计收益" :disabled="true" />
        ...
        <div class="gva-search-box">
          <el-form ref="integralInfoForm" :inline="true" :model="integralInfo">
            <el-form-item label="结算积分">
              <el-input v-model.trim="integralInfo.settlement_points" placeholder="结算积分" :disabled="true" />
              <span class="aleo">Aleo</span>
            </el-form-item>
            <el-form-item :label="`用户每股积分(${customerRate})`">
              <el-input v-model.trim="integralInfo.user_per_points" placeholder="用户每股积分" :disabled="true" />
              <span class="aleo">Aleo</span>
            </el-form-item>
