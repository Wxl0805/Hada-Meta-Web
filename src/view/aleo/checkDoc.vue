        ...
        <div class="gva-search-box" style="position: relative;">
          <el-form ref="searchForm" :model="searchInfo" :rules="rules">
            <el-form-item label="标题" prop="title">
              <el-input v-model="searchInfo.title" placeholder="请输入文章标题" @change="onTitleInputChange" disabled> </el-input>
            </el-form-item>
            <el-form-item label="作者" prop="author">
              <el-input v-model="searchInfo.author" placeholder="请输入文章作者" @change="onAuthorInputChange" disabled> </el-input>
            </el-form-item>
            ...
            <el-form-item label="文章语言" prop="language">
              <el-select v-model="searchInfo.language" clearable placeholder="请选择文章的语言类型" disabled>
